...
Plugin for Google ML Kit
  ...
  s.dependency 'GoogleMLKit/BarcodeScanning', '< 3.0'
  s.dependency 'GoogleMLKit/FaceDetection', '< 3.0'
  s.dependency 'GoogleMLKit/ImageLabeling', '< 3.0'
  s.dependency 'GoogleMLKit/TextRecognition', '< 3.0'
